...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <label class="col-md-6 col-form-label text-md-left">{!!$kategoriBerita->created_at!!} </label>
            </div>

            <div class="form-group row">
            <label class="col-md-4 col-form-label text-md-right">Update</label>
            <label class="col-md-6 col-form-label text-md-left">{!!$kategoriBerita->updated_at!!} </label>
            </div>

            <div class="form-group row mb-0">
            <div class="col-md-6 offset-md-4">
            <a href="{!! route('kategori_berita.index')!!}" class="btn btn-primary">Back</a>        
            </div>
            </div>
