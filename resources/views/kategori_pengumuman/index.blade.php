    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <td>
                    <a href="{!!route('kategori_pengumuman.show',[$item->id])!!}" class="btn-sm btn-primary">Lihat</a></td>
                    <td><a href="{!!route('kategori_pengumuman.edit',[$item->id])!!}" class="btn-sm btn-warning">Ubah</a></td>
                    <td>{!! Form::open(['route' => ['kategori_pengumuman.destroy', $item->id], 'method' =>'delete']) !!}
