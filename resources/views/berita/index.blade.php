            ...
            <div class="card">
                ...
                <table border="1">
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="{!! route('berita.show' ,[$item->id]) !!}" class="btn btn-sm btn-primary">Lihat</a></td>
                         <td><a href="{!! route('berita.edit',[$item->id])!!}" class="btn-sm btn-success">Ubah</a></td>
                         <td>{!! Form::open(['route' => ['berita.destroy', $item->id], 'method' =>'delete']) !!}
